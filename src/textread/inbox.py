...
INBOX_PATH = Path("~/.local/paperworlds/textread/inbox.jsonl")
PROCESSING_PATH = Path("~/.local/paperworlds/textread/inbox.processing.jsonl")
LOCK_PATH = Path("~/.local/paperworlds/textread/inbox.lock")
